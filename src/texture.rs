...
impl Texture {
    ...
    pub fn load_custom(assets: &DeferredAssetQueue, name: String, tex: gltf::image::Data) -> AssetHandle<Texture> {

            assets
                .enqueue_work(move |a| {
                    a.load_asset_custom(name.as_str(), move |g, _a| {
